...
let globalMentores = {}; // Cache de mentores
...
onAuthStateChanged(auth, async (user) => {
    if (user) {
        ...
        if(initialSnap.exists()){ 
            ...
            const dadosPadrao = { nome: "Novo Ninja", ryos: 100, xp: 0, nivel: 1, email: user.email, meusJutsus: [], inventario: {}, statusMissoes: {}, statusConquistas: {}, elementos: [], kekkei_genkai: [], essencia_ninja: 0, aprendizados: [] };
